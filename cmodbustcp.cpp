...
int CModbusTcp::decoder()
{
    ...
    //return 10;//Lecture Places de parking
    switch (_mode)
    {
    case 1 ://si parking
...
int CModbusTcp::decodePlaces()
{
    if(_fonction > 4){//fonction 3 ou 4
        emit sig_erreur("decodePlaces: erreur code fonction");
        return 0;
    }//if
    _Addr1Word = takeCharacter(4);//recupere l'adresse du premier mot
    _nbrOfWord = takeCharacter(4);//recupere le nombres de mots
