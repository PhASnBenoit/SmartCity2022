...
typedef struct eclairage{
    ...
    uint8_t consigne; // b1b0 : 00 = 0% / 01 = 50% / 10 = 100%  b2: ordre de test
    ...
    uint8_t lampFonct; //Indique lampadaires fonctionnels (De 0 à 5)
} T_ECLAIRAGE;
...
typedef struct intersection{
    ...
    //Voie 1
    uint8_t boutonPieton1; /* 4 par trame de voie (bit 6,5,4 en lecture octet1)
                           =>100 : 4eme bouton appuyé / 011 : 3eme bouton appuyé
                             010 : 2eme bouton appuyé / 001 : 1er bouton appuyé / 000 : Rien */
    ...
    //Voie 2
    uint8_t boutonPieton2; /* 4 par trame de voie (bit 6,5,4 en lecture octet2)
                           =>100 : 4eme bouton appuyé / 011 : 3eme bouton appuyé
                             010 : 2eme bouton appuyé / 001 : 1er bouton appuyé / 000 : Rien */
