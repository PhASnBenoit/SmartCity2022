...
CEcran::CEcran(QObject *parent, CZdc *zdc) : QObject(parent)
{
    _zdc = zdc;
    _i2c = CI2c::getInstance(this, '1'); // new objet de la classe Ci2c
    connect(_i2c, &CI2c::sigErreur, this, &CEcran::on_erreur);
    begin();
    clear();
    setColorOff();
}
...
void CEcran::on_erreur(QString mess)
{
...
void CEcran::on_ecran(QString nb)
{
