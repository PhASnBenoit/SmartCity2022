...
CIntersection::CIntersection(QObject *parent, CZdc *zdc) :  QObject(parent)
{
    _zdc = zdc;
...
void CIntersection::on_inter()
{
    ...
    qDebug() << "Boutons voie 1 : " << octet.partie.bitBoutons;
    ...
    qDebug() << "Boutons voie 2 : " << octet.partie.bitBoutons;
    ...
    qDebug() << "Ordre INTERSECTION lancé : " << uw.octet;
    sleep(1);
    //emit sig_restart();
    emit sig_eclairage();
}//OnInter
